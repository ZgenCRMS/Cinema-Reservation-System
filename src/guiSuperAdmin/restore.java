...
public class restore extends javax.swing.JDialog {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            // Choose backup file
            JFileChooser fileChooser = new JFileChooser("C:/MyBackup");
            fileChooser.setDialogTitle("Select SQL Backup File");
            ...
            if (userSelection == JFileChooser.APPROVE_OPTION) {
                ...
                String[] command = new String[]{
                    "cmd.exe", "/c",
                    "mysql -u" + db.un + " -p" + db.pw + " " + db.dbname + " < \"" + path + "\""
                };
                ...
                if (processComplete == 0) {
                    ...
                    JOptionPane.showMessageDialog(this, "❌ Restore failed. Check the SQL file and credentials.");
                }
            } else {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(this, "❌ Restore process encountered an error.");
        }
