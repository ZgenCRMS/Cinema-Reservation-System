 ...
 * @author Laky
 */
public class Hall03 extends javax.swing.JDialog {

    CashierDashboard cd;

    public Hall03(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//                }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Hall03.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Hall03 dialog = new Hall03(new javax.swing.JFrame(), true);
