 ...
 * @author Laky
 */
public class Hall01 extends javax.swing.JDialog {
...
//        disableBookedButtons();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Hall01.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Hall01 dialog = new Hall01(new javax.swing.JFrame(), true);
