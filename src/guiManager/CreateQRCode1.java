...
//    }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            ...
            String empQR = jTextField1.getText();
            Date date = new Date();
            SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
            LocalTime nowtime = LocalTime.now();

            // 🔧 Create folder if not exists
            File qrFolder = new File("C:\\QRCode");
            if (!qrFolder.exists()) {
                qrFolder.mkdirs(); // Create folder (and parents if necessary)
            }

            // 🖨️ Generate QR code
            String qrPath = "C:\\QRCode\\" + sdf.format(date) + "_" + empQR + ".png";
            generateQRcode(empQR, 1250, 1250, qrPath);

            // 💾 Save to database
            mySQL.executeIUD("INSERT INTO `emp_qr`(`qr_number`,`employee_mobile`) "
            ...
            JOptionPane.showMessageDialog(this, "Successfully Created QR Code", "Success", JOptionPane.INFORMATION_MESSAGE);
