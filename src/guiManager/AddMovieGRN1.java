...
//        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String supplier = jTextField2.getText().trim();
        String paidPriceStr = jFormattedTextField1.getText().trim();
        String selectedItem = (String) jComboBox1.getSelectedItem();

        // Input validation
        if (supplier.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Supplier field is required", "Input Error", JOptionPane.ERROR_MESSAGE);
            jTextField2.grabFocus();
            return;
        }

        if (selectedItem == null || selectedItem.equals("--Select--")) {
            JOptionPane.showMessageDialog(this, "Please select an item from the dropdown", "Input Error", JOptionPane.ERROR_MESSAGE);
            jComboBox1.grabFocus();
            return;
        }

        if (paidPriceStr.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Paid price is required", "Input Error", JOptionPane.ERROR_MESSAGE);
        ...
        try {
            double paidPrice = Double.parseDouble(paidPriceStr);
            grnItem.setBuyingprice(paidPrice);
        } catch (NumberFormatException e) {
            JOptionPane.showMessageDialog(this, "Invalid number format for price", "Input Error", JOptionPane.ERROR_MESSAGE);
            jFormattedTextField1.grabFocus();
            return;
        }

        if (grnItemMap.get(invoice) == null) {
            grnItemMap.put(invoice, grnItem);
            loadGRNItem();
        } else {
        ...
        // Optional: put again if Supplier is used as a secondary key
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        try {
            ...
            String giveA = jFormattedTextField3.getText();

            if (price.isEmpty()) {
                JOptionPane.showMessageDialog(this, "Supplier or Movie field is required", "Warning", JOptionPane.WARNING_MESSAGE);
            } else if (jFormattedTextField2.getText().trim().isEmpty()) {
                JOptionPane.showMessageDialog(this, "Payment field is required", "Warning", JOptionPane.WARNING_MESSAGE);
                jFormattedTextField2.grabFocus(); 
                return;
            } else {
