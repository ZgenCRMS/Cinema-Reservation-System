 ...
 */
public class AddMovieDimension extends javax.swing.JDialog {

    /**
     * Creates new form AddEmployee
     */
    public AddMovieDimension(java.awt.Frame parent, boolean view) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Movie Dimension");
        jPanel8.add(jLabel1);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (dimension.isEmpty()) {
            ...
            try {
                ...
                ResultSet resultSet = mySQL.executeSearch("SELECT * FROM  `movie_dimension` WHERE `type`='" + dimension + "'");
