 ...
 * @author Admin
 */
public class AddMovieHall extends javax.swing.JDialog {

    /**
     * Creates new form companyRegistration
     */
    public AddMovieHall(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        loardCompany();
        init();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Add Movie Hall");
...
//            }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AddMovieHall dialog = new AddMovieHall(new javax.swing.JFrame(), true);
