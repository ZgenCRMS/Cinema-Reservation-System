package guiSnackbar.Login;

import guiSnackbar.Login.*;
import guiLogin.*;
import com.formdev.flatlaf.themes.FlatMacDarkLaf;

import guiSnackbar.Manager.*;
        ...
        if (email.isEmpty()) {
            ...
            try {
                ...
                if (resultSet.next()) {
                    ...
                    if (userTypeId == 5) {
                        SnackCashierDashboard acd = new SnackCashierDashboard(email);
                        acd.setVisible(true);
                        setuserEmail(email);
                        this.dispose();
                    } else if (userTypeId == 4) {
                        snackbarDashboard abd = new snackbarDashboard(email);
                        abd.setVisible(true);
                        this.dispose();
                    } else {
