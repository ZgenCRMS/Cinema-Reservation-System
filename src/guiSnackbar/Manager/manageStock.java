    ...
    private void loadStock() {
        try {
            ...
            if (sort.equals("Stock ID ASC")) {
                ...
                query += "`snack_stock`.`selling_price` ASC ";
            } else if (sort.equals("Selling Price DESC")) {
                query += "`snack_stock`.`Selling_Price` DESC ";
...
//Quantity DESC
    ...
    private void initComponents() {
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Stock ID ASC", "Stock ID DESC", "Product ID ASC", "Product ID DESC", "Selling Price ASC", "Selling Price DESC", "Quantity ASC", "Quantity DESC", " " }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (pname.isEmpty()) {
            ...
            try {
                ...
                ResultSet resultSet = mySQL.executeSearch("SELECT * FROM `snack_product` WHERE `product` = '" + pname + "' AND `brand_id` = '" + brandMap.get(pb) + "'");
