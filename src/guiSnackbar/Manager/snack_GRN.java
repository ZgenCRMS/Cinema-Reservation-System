...
public class snack_GRN extends javax.swing.JFrame {
    ...
    HashMap<String, snackGrnitem1> snackGrnitemMap = new HashMap<>();

    public snack_GRN(String email) {
        initComponents();
        init();
        generateGRNId();
        loadGRNItem();
    ...
    private void hint() {
        ...
        if (jTextField2 != null) {
            jTextField2.putClientProperty(FlatClientProperties.PLACEHOLDER_TEXT, "Supplier Mobile");
        }
        if (jTextField4 != null) {
            jTextField4.putClientProperty(FlatClientProperties.PLACEHOLDER_TEXT, "Product Id");
        }
    ...
    private void loadGRNItem() {
        ...
        double total = 0;
        for (snackGrnitem1 snGrnItem : snackGrnitemMap.values()) {
    ...
    private void initComponents() {
        ...
        jPanel2.setPreferredSize(new java.awt.Dimension(1129, 100));
        ...
        jPanel176.setBackground(new java.awt.Color(31, 35, 51));
        jPanel176.setPreferredSize(new java.awt.Dimension(215, 100));
        jPanel176.setLayout(new java.awt.GridLayout(1, 0));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resource/cinema (2).png"))); // NOI18N
        jPanel176.add(jLabel1);

        jPanel1.add(jPanel176, java.awt.BorderLayout.LINE_START);

        jPanel177.setBackground(new java.awt.Color(31, 35, 51));
        jPanel177.setPreferredSize(new java.awt.Dimension(215, 100));
        jPanel177.setLayout(new java.awt.BorderLayout());

        jPanel178.setBackground(new java.awt.Color(31, 35, 51));
        jPanel178.setPreferredSize(new java.awt.Dimension(205, 100));
        jPanel178.setLayout(new java.awt.BorderLayout());

        jPanel179.setBackground(new java.awt.Color(31, 35, 51));
        jPanel179.setPreferredSize(new java.awt.Dimension(205, 60));
        ...
        jPanel179.add(jLabel17, java.awt.BorderLayout.PAGE_END);

        jLabel29.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel29.setForeground(new java.awt.Color(255, 255, 255));
        jLabel29.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel29.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resource/contacts-32.png"))); // NOI18N
        jLabel29.setText("Welcome");
        jLabel29.setToolTipText("");
        jPanel179.add(jLabel29, java.awt.BorderLayout.CENTER);

        jPanel178.add(jPanel179, java.awt.BorderLayout.PAGE_START);

        jPanel183.setBackground(new java.awt.Color(31, 35, 51));

        jLabel30.setForeground(new java.awt.Color(255, 255, 255));
        jLabel30.setText("2024/05/09   10.00 PM");

        jLabel31.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resource/clock.png"))); // NOI18N
        ...
        jPanel178.add(jPanel183, java.awt.BorderLayout.CENTER);

        jPanel177.add(jPanel178, java.awt.BorderLayout.LINE_START);

        jPanel1.add(jPanel177, java.awt.BorderLayout.LINE_END);

        jPanel184.setBackground(new java.awt.Color(31, 35, 51));
        ...
        jLabel32.setText("SnackBar GRN");
        jPanel184.add(jLabel32, java.awt.BorderLayout.CENTER);

        jPanel1.add(jPanel184, java.awt.BorderLayout.CENTER);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        String brandName = jLabel3.getText();
        ...
        if (suppmobile.isEmpty() || brancId.isEmpty() || qty.isEmpty() || buying_price.isEmpty() || selling_price.isEmpty() || mfd == null || exp == null) {
            JOptionPane.showMessageDialog(this, "All fields must be filled", "Validation Error", JOptionPane.ERROR_MESSAGE);
            return;
        }
        if (brandName.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Invalid Supplier Or Product", "Validation Error", JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        snackGrnitem1 grnItem = new snackGrnitem1();
        ...
        if (snackGrnitemMap.get(jTextField4.getText()) == null) {
            snackGrnitemMap.put(jTextField4.getText(), grnItem);
            loadGRNItem();
            generateGRNId();

        } else {

            snackGrnitem1 found = snackGrnitemMap.get(jTextField4.getText());
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        if (pay.isEmpty()) {
            ...
            try {
                ...
                for (snackGrnitem1 grnItem : snackGrnitemMap.values()) {
...
//insert
    ...
    private void jFormattedTextField3KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jFormattedTextField3KeyReleased
        String tx = jFormattedTextField3.getText();

        if (!tx.matches("\\d*")) {

            jFormattedTextField3.setText(tx.replaceAll("[^\\\\d]", ""));
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        if (evt.getClickCount() == 2) {
            ...
            if (selectedRow != -1) {
                ...
                snackGrnitemMap.remove(stockID);
